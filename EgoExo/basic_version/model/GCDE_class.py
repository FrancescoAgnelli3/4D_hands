...
class NeuralGCDE(nn.Module):
    def __init__(self, func_f, func_g, input_channels, hidden_channels, output_channels, num_nodes, num_layers, embed_dim, atol, rtol, solver):
    ...
    def forward(self, spline, times):
        ...
        #CNN based predictor
        output = self.end_conv(z_T).squeeze(-1) 
