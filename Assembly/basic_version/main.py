...
path_loader = "/mnt/wwn-0x5000000000000001-part1/datasets/AssemblyHands/assembly101-download-scripts/data_processed/train_loader.pt"

batch_dim = 64
train_dataset = Assembly_dataloader(path_loader, path_data = path, train = True)
...
path_loader_val = "/mnt/wwn-0x5000000000000001-part1/datasets/AssemblyHands/assembly101-download-scripts/data_processed/test_loader.pt"

test_dataset = Assembly_dataloader(path_loader_val, path_data = path, train = False)
...
for hc in [4,8,16,32,64]:  #4,8,16,32,64,128
    for model_name in ["NODE", "CNN"]: #, "CNN" "NODE",
